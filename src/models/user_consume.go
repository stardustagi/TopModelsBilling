...
type UserConsumeRecord struct {
	...
	RebateDeducted   int64  `xorm:"bigint default 0 comment('返点扣除金额')" json:"rebate_deducted"`   // 返点扣除金额
	BalanceDeducted  int64  `xorm:"bigint default 0 comment('余额扣除金额')" json:"balance_deducted"`  // 余额扣除金额
	...
	TokensPerSec int     `xorm:"-" json:"tokens_per_sec"`
	Latency      float64 `xorm:"-" json:"latency"`
}
